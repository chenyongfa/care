...
def sendMail():
    ...
    my_sender = Contant.senderEmail    # 发件人邮箱账号
    my_pass = Contant.emailPassword              # 发件人邮箱密码
    my_user = Contant.receiverEmail    # 收件人邮箱账号，我这边发送给自己
    ...
    msg['Subject']=u"care系统自动化测试报告"                # 邮件的主题，也可以说是标题
